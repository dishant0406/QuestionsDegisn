      ...
      <div className='h-[100vh] w-[70vw] flex justify-center items-center'>
        <div className='h-[50vh] w-[50vw]'>
          <div>
            ...
            <p className='font-[500] text-[30px]'>What bothers you most about your skin?</p>
          ...
          <div className='flex w-[50vw] justify-center mt-[2rem]'>
            <Link to={'/2'} className='w-[20rem] flex items-center justify-center hover:bg-[#6fb09a] transition text-[20px] font-[500] opacity-[0.9] h-[3rem] bg-[#7BC4AB] text-[#fff] transition border rounded border-[#7BC4AB]'>NEXT</Link>
          </div>
        </div>
      </div>
