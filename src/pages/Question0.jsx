        ...
        <div className='h-[50vh] w-[50vw]'>
          ...
          <div className='flex mt-[2rem] flex-col gap-[0.5rem]'>
            <div className='flex shrink-0 flex-wrap gap-[1rem]'>
              <input value={questions.age} onChange={e=>setQuestions({...questions, age:e.target.value})} placeholder='Your Age' className='w-[20rem] px-[1rem] focus:outline-none transition text-[20px] font-[500] opacity-[0.9] h-[3rem] transition border rounded border-[#7BC4AB]'/>
            </div>
          </div>
          <div className='flex w-[50vw] justify-start mt-[2rem]'>
            <Link to={questions.age!==''?'/1':'/'} className={`w-[20rem] flex items-center justify-center ${questions.age===''?'cursor-not-allowed':''} hover:bg-[#6fb09a] transition text-[20px] font-[500] opacity-[0.9] h-[3rem] bg-[#7BC4AB] text-[#fff] transition border rounded border-[#7BC4AB]`}>NEXT</Link>
          </div>
        </div>
      </div>
